...
- Onglet Classe/Groupe (Gestion de classe) : les classes peuvent désormais être
  **réorganisées par glisser-déposer**, via la poignée (icône à 6 points) sur chaque carte de
  classe — fonctionne au doigt comme à la souris. Le nouvel ordre est sauvegardé comme le
